...
print("Saving Model ... ", end = "")
torch.save(model.state_dict(), "{}/attention.torch".format(base_dir, epoch))
torch.save(optimizer.state_dict(), "{}/attention.torch".format(base_dir, epoch))
print("Model Saved.")
print("Plotting train/valid loss ... ", end = "")
# Save a plot of the average loss over time
plt.clf()
